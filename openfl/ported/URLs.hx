...
class URLs
{
    public static var protocol(never, set) : String;

    public static var ROOT_URL : String = "www.flashflashrevolution.com";
     ...
     * @param val Protocol
     */
    private static function set_protocol(val : String) : String
