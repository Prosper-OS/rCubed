...
class TweenLite extends Animation
{
 ...
 TweenLite.ticker.removeEventListener("tick", myFunction);
    ...
    private static var _tweenLookup : Dictionary<Dynamic, Dynamic> = new Dictionary<Dynamic, Dynamic>(false);
    ...
    public var _propLookup : Dynamic;
    ...
    public function new(target : Dynamic, duration : Float, vars : Dynamic)
    {
        ...
        if (_overwriteLookup == null)
        {
            ...
            Reflect.setField(_overwriteLookup, "true", 1);
            Reflect.setField(_overwriteLookup, "false", 0);
        ...
        _overwrite = ((!(Lambda.has(this.vars, "overwrite")))) ? Reflect.field(_overwriteLookup, defaultOverwrite) : ((as3hx.Compat.typeof((this.vars.overwrite)) == "number")) ? this.vars.overwrite >> 0 : Reflect.field(_overwriteLookup, Std.string(this.vars.overwrite));
        
        if (Std.is(this.target, Array) && as3hx.Compat.typeof((this.target[0])) == "object")
        {
        ...
        {
            _propLookup = { };
            _siblings = Reflect.field(_tweenLookup, Std.string(target));
            if (_siblings == null) {
_siblings = Reflect.setField(_tweenLookup, Std.string(target), [this]);
            }
            else
            {
...
if (!(Lambda.has(_reservedProps, p)))
                    {
        ...
        else if (as3hx.Compat.typeof((vars.ease)) == "function")
        {
        ...
        if (_targets != null)
        {
            ...
            while (--i > -1)
            {
                if (_initProps(_targets[i], Reflect.setField(_propLookup, Std.string(i), { }), _siblings[i], (_overwrittenProps != null) ? Reflect.field(_overwrittenProps, Std.string(i)) : null))
                {
                    initPlugins = true;
                }
            }
        ...
        if (_overwrittenProps != null)
        {
            if (_firstPT == null)
            {
                if (as3hx.Compat.typeof((target)) != "function") {
_enabled(false, false);
    ...
    private function _initProps(target : Dynamic, propLookup : Dynamic, siblings : Array<Dynamic>, overwrittenProps : Dynamic) : Bool
    {
        var vars : Dynamic = this.vars;
        var p : String;
        var i : Int;
        var initPlugins : Bool;
        var plugin : Dynamic;
        ...
        for (p in Reflect.fields(vars))
        {
            ...
            if (Lambda.has(_reservedProps, p))
            {
                if (Std.is(val, Array))
                {
                    ...
                    {
                        Reflect.setField(vars, p, _swapSelfInParams(try cast(val, Array<Dynamic>) catch(e:Dynamic) null));
                    }
                }
            }
            else if ((Lambda.has(_plugins, p)) && (plugin = new Plugins()[p]())._onInitTween(target, val, this))
            {
                _firstPT = new PropTween(plugin, "setRatio", 0, 1, p, true, _firstPT, plugin._priority);
                i = plugin._overwriteProps.length;
                while (--i > -1)
                {
                    Reflect.setField(propLookup, Std.string(plugin._overwriteProps[i]), _firstPT);
                }
                if (plugin._priority || (Lambda.has(plugin, "_onInitAllProps")))
                {
                    initPlugins = true;
                }
                if ((Lambda.has(plugin, "_onDisable")) || (Lambda.has(plugin, "_onEnable")))
                {
            ...
            {
                _firstPT = Reflect.setField(propLookup, p, new PropTween(target, p, 0, 1, p, false, _firstPT));
                _firstPT.s = ((!_firstPT.f)) ? as3hx.Compat.parseFloat(Reflect.field(target, p)) : Reflect.field(target, Std.string((((p.indexOf("set") || !(Lambda.has(target, "get" + p.substr(3))))) ? p : "get" + p.substr(3))))();
                _firstPT.c = ((as3hx.Compat.typeof((val)) == "number")) ? as3hx.Compat.parseFloat(val) - _firstPT.s : ((as3hx.Compat.typeof((val)) == "string" && val.charAt(1) == "=")) ? as3hx.Compat.parseInt(val.charAt(0) + "1") * as3hx.Compat.parseFloat(val.substr(2)) : as3hx.Compat.parseFloat(val) || 0;
            }
        }
        
        if (overwrittenProps != null)
        {
...
_rawPrevTime = 0;
    ...
    override public function _kill(vars : Dynamic = null, target : Dynamic = null) : Bool
    {
        ...
        var i : Int;
        var overwrittenProps : Dynamic;
        var p : String;
        var pt : PropTween;
        var propLookup : Dynamic;
        var changed : Bool;
        var killProps : Dynamic;
        var record : Bool;
        if (Std.is(target, Array) && as3hx.Compat.typeof((Reflect.field(target, Std.string(0)))) == "object")
        {
            i = target.length;
            while (--i > -1)
            {
                if (_kill(vars, Reflect.field(target, Std.string(i))))
                {
                    changed = true;
                }
            }
        ...
        else
        {
            if (_targets != null)
            {
                ...
                while (--i > -1)
                {
                    ...
                    {
                        propLookup = Reflect.field(_propLookup, Std.string(i)) || { };
                        _overwrittenProps = _overwrittenProps || [];
                        overwrittenProps = Reflect.setField(_overwrittenProps, Std.string(i), (vars != null) ? Reflect.field(_overwrittenProps, Std.string(i)) || { } : "all");
                        break;
                    }
                }
            }
            ...
            else
            {
                ...
                overwrittenProps = _overwrittenProps = (vars != null) ? _overwrittenProps || { } : "all";
            }
            if (propLookup != null)
            {
                killProps = vars || propLookup;
                record = (vars != overwrittenProps && overwrittenProps != "all" && vars != propLookup && (as3hx.Compat.typeof((vars)) != "object" || vars._tempKill != true));  //_tempKill is a super-secret way to delete a particular tweening property but NOT have it remembered as an official overwritten property (like in BezierPlugin)  
                for (p in Reflect.fields(killProps))
                {
                    pt = Reflect.field(propLookup, p);
                    if (pt != null)
                    {
                        ...
                        Reflect.deleteField(propLookup, p);
                    }
                    if (record)
                    {
                        Reflect.setField(overwrittenProps, p, 1);
                    }
                }
...
TweenLite.fromTo([mc1, mc2, mc3], 1, {x:0}, {x:100});
    ...
    private static function _prepVars(vars : Dynamic, immediateRender : Bool = false) : Dynamic
    {
        if (vars._isGSVars)
        {
            vars = vars.vars;
        }
        if (immediateRender && !(Lambda.has(vars, "immediateRender")))
        {
...
var i : Int;
            var a : Array<Dynamic>;
            var tgt : Dynamic;
            for (tgt in Reflect.fields(_tweenLookup))
            {
                a = Reflect.field(_tweenLookup, Std.string(tgt));
                i = a.length;
                while (--i > -1)
                {
                    if (a[i]._gc)
                ...
                if (a.length == 0)
                {
                    Reflect.deleteField(_tweenLookup, Std.string(tgt));
                }
            }
        }
    }
    ...
    {
        if (as3hx.Compat.typeof((onlyActive)) == "object")
        {
            vars = onlyActive;  //for backwards compatibility (before "onlyActive" parameter was inserted)  
            onlyActive = false;
        }
        var a : Array<Dynamic> = TweenLite.getTweensOf(target, onlyActive);
        var i : Int = a.length;
        while (--i > -1)
        {
...
var a2 = TweenLite.getTweensOf([myObject1, myObject2]); //finds 3 tweens
    ...
    public static function getTweensOf(target : Dynamic, onlyActive : Bool = false) : Array<Dynamic>
    {
        ...
        var j : Int;
        var t : TweenLite;
        if (Std.is(target, Array) && as3hx.Compat.typeof((Reflect.field(target, Std.string(0)))) != "string" && as3hx.Compat.typeof((Reflect.field(target, Std.string(0)))) != "number")
        {
            i = target.length;
            a = [];
            while (--i > -1)
            {
                a = a.concat(getTweensOf(Reflect.field(target, Std.string(i)), onlyActive));
            }
            i = a.length;
    ...
    /** 
		 ...
		 **/
    private static function _register(target : Dynamic, tween : TweenLite = null, scrub : Bool = false) : Array<Dynamic>
    {
        var a : Array<Dynamic> = Reflect.field(_tweenLookup, Std.string(target));
        var i : Int;
        if (a == null)
        {
            a = Reflect.setField(_tweenLookup, Std.string(target), []);
        }
        if (tween != null)
        {
            i = a.length;
    ...
    private static function _applyOverwrite(target : Dynamic, tween : TweenLite, props : Dynamic, mode : Int, siblings : Array<Dynamic>) : Bool
    {
        var i : Int;
        var changed : Bool;
        ...
        var startTime : Float = tween._startTime + 0.0000000001;
        var overlaps : Array<Dynamic> = [];
        var oCount : Int = 0;
        var zeroDur : Bool = (tween._duration == 0);
        var globalStart : Float;
        i = siblings.length;
        while (--i > -1)
        {
            curTween = siblings[i];
...
changed = true;
    ...
    /** 
		 ...
		 **/
    private static function _checkOverlap(tween : Animation, reference : Float, zeroDur : Bool) : Float
    {
        var tl : SimpleTimeline = tween._timeline;
        var ts : Float = tl._timeScale;
        var t : Float = tween._startTime;
        var min : Float = 0.0000000001;
        while (tl._timeline)
        {
            t += tl._startTime;
            ts *= tl._timeScale;
