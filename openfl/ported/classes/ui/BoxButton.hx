...
class BoxButton extends Box
{
    ...
    public var textColor(never, set) : String;
    ...
    public function new(parent : DisplayObjectContainer = null, xpos : Float = 0, ypos : Float = 0, width : Float = 0, height : Float = 0, text : String = "", size : Int = 12, listener : Dynamic = null)
    {
...
if (_hoverText == null)
    ...
    private function set_textColor(color : String) : String
    {
